...
public class GridManager : MonoBehaviour
{
    ...
    public void getGrid()
    {
		...
		gridOne.transform.Rotate(90.0f, 0f, 0f, Space.World);
		gridTwo.transform.Rotate(90.0f, 0f, 0f, Space.World);

		Vector3 scaleChange = gridOne.transform.localScale;
		scaleChange *= 0.01f; // or scale.x = Time.deltaTime
		gridOne.transform.localScale = scaleChange;

		Vector3 scaleChange2 = gridTwo.transform.localScale;
		scaleChange2 *= 0.01f; // or scale.x = Time.deltaTime
		gridTwo.transform.localScale = scaleChange2;

		gridOne.transform.position = new Vector3(gridOne.transform.position.x , gridOne.transform.position.y + 0.70f, gridOne.transform.position.z - 0.098f);
		gridTwo.transform.position = new Vector3(gridTwo.transform.position.x - 49.4f, gridTwo.transform.position.y + 0.70f, gridTwo.transform.position.z - 0.098f);
	}
